...
// This example shows how to create a (Route) Filter that performs OAuth2 Bearer Authentication on the Http request.
//
...
func main() {
	...
	ws.Route(ws.GET("/secret").Filter(bearerAuthenticate).To(secret))
	restful.Add(ws)
	http.ListenAndServe(":8080", nil)
}

func bearerAuthenticate(req *restful.Request, resp *restful.Response, chain *restful.FilterChain) {
